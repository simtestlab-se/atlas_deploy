...
Regardless of whether the cell is new or not, the cell cycle counters shall be set to 0 for the first time.  
The counters can remain at 0 until a capacity estimation is made for each cell.  
The cycle counters shall keep track of the consumed cycles.
